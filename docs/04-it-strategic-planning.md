...
O Plano Estratégico de Tecnologia da Informação (PETI) tem como finalidade dar continuidade ao uso estratégico da TI na organização, apoiando a gestão com informações confiáveis e relevantes, geradas a partir de seus próprios dados operacionais. A TI deve contribuir diretamente para a melhoria da eficiência dos serviços, da tomada de decisão baseada em dados e da organização dos processos internos.
...
Para avaliar a evolução da TI e o impacto do BI na operação, propõem-se os seguintes indicadores:
...
A norma ISO/IEC 38500 orienta a governança de TI com base em seis princípios:
...
- **EDM01 – Estrutura de governança definida**  
  PETI documentado com responsabilidades, metas e prioridades. Governança simplificada, acessível e alinhada ao porte da organização.

- **EDM02 – Entrega de benefícios**  
  Dashboards operacionais entregam valor direto. Métricas relevantes são usadas na operação e gestão.
...
A segurança e proteção dos dados é estruturada com base em dois pilares: gestão de segurança conforme a norma ISO/IEC 27001 e referência em práticas do NIST Cybersecurity Framework (CSF). Essa abordagem garante proteção integral dos dados pessoais e operacionais, bem como resiliência contra ameaças digitais.

#### Gestão de segurança da informação – ISO/IEC 27001

Recomenda-se que a empresa adote diretrizes da ISO 27001 para estabelecer um Sistema de Gestão da Segurança da Informação (SGSI), considerando os seguintes controles:
...
Recomenda-se que a organização estruture sua proteção cibernética segundo os cinco pilares do NIST:
